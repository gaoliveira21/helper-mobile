      ...
      <ScrollView>
        <Form>
          ...
          <Input
            ...
            icon={({ color }) => <MaterialIcons name="phone" size={24} color={color} />}
            error=''
          />
          <Input
            label='Cidade'
          ...
          <Button color='#FF6B6C' onPress={() => navigation.navigate('ChangePassword')}>
            <MaterialIcons name="lock" color='#FFF' size={24} />
            <TextButton>Alterar Senha</TextButton >
          </Button>

          <Button color='#5B5F97' onPress={() => navigation.navigate('CreditCard')}>
